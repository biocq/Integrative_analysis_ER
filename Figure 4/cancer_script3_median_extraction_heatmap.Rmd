...
write.table(final, file = paste0(Prefix,"part5/medianlog_tumor&normal.tpm.tsv"), quote=FALSE,row.names=F, col.names=F,sep="\t")
medianfile<-read.table(paste0(Prefix,"part5/medianlog_tumor&normal.tpm.tsv"), header=T, sep="\t")
...
pdf(paste0(Prefix,"part5/heatmap.tumorvsnormal_median.logtpm.pdf"),height=20,width=25)
