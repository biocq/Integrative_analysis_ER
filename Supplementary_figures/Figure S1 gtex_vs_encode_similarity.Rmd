---
title: "gtex_vs_encode_similarity"
...
input2 <- "ER.encode.TPM.brainav.tsv"
...
gtex_input<- read.delim(paste0(Prefix,"part2/",input1)) #ER.GTEX.TissueAveraged.TPM.tsv
rownames(gtex_input)<- gtex_input$Symbol
gtex_input<- gtex_input[,-c(1:3)]
encode_input<- read.delim(paste0(Prefix,"part2/",input2))#ER.encode.TPM.brainav.tsv
...
gtex = gtex_input[,common_t] 
encode = encode_input[,common_t] 
